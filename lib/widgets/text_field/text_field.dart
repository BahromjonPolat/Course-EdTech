...
class TextFieldMark extends StatelessWidget {
  ...
  TextFieldMark({required this.hintText, this.check, Key? key})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return TextField(
      ...
      onSubmitted: (v) {
        _searchFunction(context, check!);
      },
      cursorHeight: getUniqueHeight(21),
      decoration: InputDecoration(
        suffixIcon: IconButton(
          onPressed: () {},
          icon: SvgPicture.asset(IconPath.search, fit: BoxFit.none, height: 20),
        ),
        hintText: hintText,
        hintStyle: TextStyle(
        ...
        Navigator.push(
            ...
            MaterialPageRoute(
                builder: (context) => SearchResultPage(
                      searchText: _searchText.toString(),
                    )));
      }
    }
  }
